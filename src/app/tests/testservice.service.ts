    ...
    if (this.serverService.status) {
      ...
      for (let host = 0; host < this.serverService.status.length; host++) {
        ...
        if (this.serverService.status[host].hostname === "creede") {
          this.serverService.status[host].epoch  = (Number(Number(currentEpoch)).toFixed(3));
          //this.serverService.status[host].status = "green";
        } else if (this.serverService.status[host].hostname === "ubuntu2") {
          this.serverService.status[host].epoch  = "1728597022";
          //this.serverService.status[host].status = "red";
        } else if (this.serverService.status[host].hostname === "ubuntu-node03") {
          this.serverService.status[host].epoch  = "1728597022";
         // this.serverService.status[host].status = "red";
        } else if (this.serverService.status[host].hostname === "ubuntu-node01") {
          this.serverService.status[host].epoch  = (Number(Number(currentEpoch)).toFixed(3));
          //this.serverService.status[host].status = "green";
