...
export class ServerService {
    ...
    private baseHostIP:   string = "my.serverstatus.com/"; //192.168.1.100";//"nginx.ingress.192.168.1.100.nip.io"; //"serverstatus-service.default"; //"mynginx.192.168.1.100.nip.io"; //"192.168.1.100";
