...
//   constructor(@Inject(String) checksum:string, cpuinfo:any, disks:any, epoch:string, groups:any, hostname: string, icon:string, lastUpdate:string, local: string, logavail: string, logpercent: string, logtotal: string, 
